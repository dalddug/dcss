...
{ SP_ARMATAUR, {
    ...
    { { MUT_ARMOURED_TAIL, 1, 1 }, { MUT_AWKWARD_TONGUE, 1, 1 }, { MUT_DEFORMED, 1, 1 }, { MUT_LONG_TONGUE, 1, 1 }, { MUT_ROLLPAGE, 1, 1 }, { MUT_RUGGED_BROWN_SCALES, 3, 1 } },
    {},
    {},
...
{ SP_DEEP_ELF, {
    ...
    {},
    {},
    { JOB_HEDGE_WIZARD, JOB_CONJURER, JOB_SUMMONER, JOB_NECROMANCER, JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST, JOB_AIR_ELEMENTALIST, JOB_EARTH_ELEMENTALIST, JOB_VENOM_MAGE },
...
{ SP_DEMONSPAWN, {
    ...
    12, 13, 12,
    { STAT_STR, STAT_INT, STAT_DEX }, 4,
    {{ MUT_NEGATIVE_ENERGY_RESISTANCE, 3, 1 }, { MUT_MULTILIVED, 1, 1 }, { MUT_COLD_RESISTANCE, 1, 1 }, { MUT_DEVOUR_ON_KILL, 1, 1 }, { MUT_NEGATIVE_ENERGY_RESISTANCE, 3, 1 }, { MUT_TORMENT_RESISTANCE, 2, 1 }, { MUT_REGENERATION, 1, 1 }, {MUT_SHOCK_RESISTANCE, 1, 1 } },
    {},
    {},
    { JOB_GLADIATOR, JOB_BERSERKER, JOB_HEDGE_WIZARD, JOB_NECROMANCER, JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST, JOB_VENOM_MAGE },
    { SK_LONG_BLADES, SK_AXES, SK_MACES_FLAILS, SK_POLEARMS, SK_STAVES, SK_RANGED_WEAPONS },
    nullptr,
    nullptr,
} },
...
{ SP_DJINNI, {
    ...
    { "sickness immunity" },
    { JOB_GLADIATOR, JOB_TRANSMUTER, JOB_HEDGE_WIZARD, JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST },
...
{ SP_FELID, {
    ...
    4, 9, 11,
    { STAT_INT, STAT_DEX }, 5,
    { { MUT_ACUTE_VISION, 1, 1 }, { MUT_CLAWS, 1, 1 }, { MUT_FANGS, 3, 1 }, { MUT_FAST, 1, 1 }, { MUT_MULTILIVED, 1, 1 }, { MUT_NO_ARMOUR, 1, 1 }, { MUT_NO_GRASPING, 1, 1 }, { MUT_PAWS, 1, 1 }, { MUT_SHAGGY_FUR, 1, 1 }, { MUT_SHAGGY_FUR, 1, 6 }, { MUT_SHAGGY_FUR, 1, 12 } },
    {},
    {},
...
{ SP_FORMICID, {
    ...
    { JOB_FIGHTER, JOB_HUNTER, JOB_HEXSLINGER, JOB_EARTH_ELEMENTALIST, JOB_VENOM_MAGE },
...
{ SP_GARGOYLE, {
    ...
    HT_LAND, US_ALIVE, SIZE_MEDIUM,
    15, 13, 9,
    { STAT_STR, STAT_INT }, 3, { STAT_STR, STAT_INT, STAT_DEX }, 4,
    { { MUT_NEGATIVE_ENERGY_RESISTANCE, 3, 1 }, { MUT_PETRIFICATION_RESISTANCE, 1, 1 }, { MUT_SHOCK_RESISTANCE, 1, 1 }, { MUT_TORMENT_RESISTANCE, 2, 1 }, { MUT_BIG_WINGS, 1, 14 }, { MUT_REGENERATION, 2, 1 }, { MUT_COLD_RESISTANCE, 1, 1 }, { MUT_DEVOUR_ON_KILL, 1, 1 }, { MUT_QUADRUMANOUS, 1, 1 }, { MUT_MULTILIVED, 1, 1 } }, 
    { "You are immune to sickness and miasma." },
    { "sickness immunity" },
    { JOB_FIGHTER, JOB_GLADIATOR, JOB_MONK, JOB_BERSERKER, JOB_FIRE_ELEMENTALIST, JOB_EARTH_ELEMENTALIST, JOB_VENOM_MAGE, JOB_REAVER },
...
{ SP_GHOUL, {
    ...
    13, 6, 8,
    { STAT_STR }, 3,
    { { MUT_CLAWS, 1, 1 }, { MUT_COLD_RESISTANCE, 1, 1 }, { MUT_DEVOUR_ON_KILL, 1, 1 }, { MUT_NEGATIVE_ENERGY_RESISTANCE, 3, 1 }, { MUT_TORMENT_RESISTANCE, 2, 1 }, { MUT_REGENERATION, 1, 1 }, { MUT_SHAGGY_FUR, 1, 1 }, { MUT_TOUGH_SKIN, 1, 1 } },
    {},
    {},
...
{ SP_GNOLL, {
    ...
    {},
    {},
    { JOB_CINDER_ACOLYTE, JOB_REAVER, JOB_WARPER, JOB_HEXSLINGER, JOB_TRANSMUTER, JOB_WANDERER },
    { SK_LONG_BLADES, SK_AXES, SK_MACES_FLAILS, SK_POLEARMS, SK_STAVES, SK_RANGED_WEAPONS },
    nullptr,
    nullptr,
} },
...
{ SP_KOBOLD, {
    ...
    {},
    {},
    { JOB_BRIGAND, JOB_BERSERKER, JOB_HEXSLINGER, JOB_ENCHANTER, JOB_CONJURER, JOB_SUMMONER },
...
{ SP_MERFOLK, {
    ...
    {},
    {},
    { JOB_GLADIATOR, JOB_BERSERKER, JOB_TRANSMUTER, JOB_SUMMONER, JOB_ICE_ELEMENTALIST, JOB_VENOM_MAGE },
...
{ SP_METEORAN, {
    ...
    {},
    {},
    { JOB_FIGHTER, JOB_WANDERER, JOB_CINDER_ACOLYTE, JOB_TRANSMUTER, JOB_REAVER, JOB_EARTH_ELEMENTALIST },
    { SK_MACES_FLAILS, SK_POLEARMS, SK_AXES, SK_STAVES, SK_LONG_BLADES },
    nullptr,
    nullptr,
} },
...
{ SP_MUMMY, {
    ...
    11, 7, 7,
    { STAT_STR, STAT_INT, STAT_DEX }, 5,
    { { MUT_COLD_RESISTANCE, 1, 1 }, { MUT_FAITH, 1, 1 }, { MUT_HEAT_VULNERABILITY, 1, 1 }, { MUT_NEGATIVE_ENERGY_RESISTANCE, 3, 1 }, { MUT_NO_DRINK, 1, 1 }, { MUT_TORMENT_RESISTANCE, 2, 1 }, { MUT_NECRO_ENHANCER, 1, 3 }, { MUT_NECRO_ENHANCER, 1, 13 } },
    {},
    {},
...
{ SP_NAGA, {
    ...
    {},
    {},
    { JOB_BERSERKER, JOB_TRANSMUTER, JOB_ENCHANTER, JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST, JOB_WARPER, JOB_HEDGE_WIZARD, JOB_VENOM_MAGE },
    { SK_LONG_BLADES, SK_AXES, SK_MACES_FLAILS, SK_POLEARMS, SK_STAVES, SK_RANGED_WEAPONS },
    "Slither",
    "coil in front of",
} },
...
{ SP_OCTOPODE, {
    ...
    { "almost no armour" },
    { JOB_TRANSMUTER, JOB_HEDGE_WIZARD, JOB_CONJURER, JOB_BRIGAND, JOB_FIRE_ELEMENTALIST, JOB_EARTH_ELEMENTALIST, JOB_VENOM_MAGE },
    { SK_LONG_BLADES, SK_AXES, SK_MACES_FLAILS, SK_POLEARMS, SK_STAVES, SK_RANGED_WEAPONS },
    "Wriggl",
    "curl up in front of",
} },
...
{ SP_SPRIGGAN, {
    ...
    {},
    {},
    { JOB_BRIGAND, JOB_ARTIFICER, JOB_WARPER, JOB_ENCHANTER, JOB_CONJURER, JOB_EARTH_ELEMENTALIST, JOB_VENOM_MAGE },
    { SK_SHORT_BLADES },
    nullptr,
    nullptr,
} },
...
{ SP_TENGU, {
    ...
    {},
    {},
    { JOB_BERSERKER, JOB_REAVER, JOB_HEDGE_WIZARD, JOB_CONJURER, JOB_SUMMONER, JOB_FIRE_ELEMENTALIST, JOB_AIR_ELEMENTALIST, JOB_VENOM_MAGE },
...
{ SP_VAMPIRE, {
    ...
    {},
    {},
    { JOB_GLADIATOR, JOB_BRIGAND, JOB_ENCHANTER, JOB_NECROMANCER, JOB_EARTH_ELEMENTALIST, JOB_ICE_ELEMENTALIST },
...
{ SP_VINE_STALKER, {
    ...
    10, 8, 9,
    { STAT_STR, STAT_DEX }, 4,
    { { MUT_ANTIMAGIC_BITE, 1, 1 }, { MUT_FANGS, 2, 1 }, { MUT_MANA_SHIELD, 1, 1 }, { MUT_NO_POTION_HEAL, 2, 1 }, { MUT_REGENERATION, 1, 4 }, { MUT_FANGS, 1, 8 } },
    {},
    {},
