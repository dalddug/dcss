...
static vector<ability_def> &_get_ability_list()
{
    ...
    static vector<ability_def> Ability_List =
    {
        ...
        { ABIL_ZIN_VITALISATION, "Vitalisation",
            0, 0, 0, -1, {fail_basis::invo, 40, 5, 20}, abflag::none },
        { ABIL_ZIN_IMPRISON, "Imprison",
            0, 0, 0, LOS_MAX_RANGE, {fail_basis::invo, 60, 5, 20},
            abflag::target | abflag::not_self },
        { ABIL_ZIN_SANCTUARY, "Sanctuary",
            0, 0, 0, -1, {fail_basis::invo, 80, 4, 25}, abflag::none },
        ...
        { ABIL_TSO_CLEANSING_FLAME, "Cleansing Flame",
            0, 0, 0, -1, {fail_basis::invo, 70, 4, 25}, abflag::none },
        ...
        { ABIL_OKAWARU_FINESSE, "Finesse",
            0, 0, 0, -1, {fail_basis::invo, 60, 4, 25}, abflag::none },
        { ABIL_OKAWARU_DUEL, "Duel",
            0, 0, 0, LOS_MAX_RANGE, {fail_basis::invo, 80, 4, 20},
            abflag::target | abflag::not_self },
        ...
        { ABIL_TROG_BERSERK, "Berserk",
            0, 0, 0, -1, {fail_basis::invo, 45, 0, 2}, abflag::none },
        { ABIL_TROG_HAND, "Trog's Hand",
            0, 0, 0, -1, {fail_basis::invo, piety_breakpoint(2), 0, 1},
            abflag::none },
        { ABIL_TROG_BROTHERS_IN_ARMS, "Brothers in Arms",
            0, 0, 0, -1, {fail_basis::invo, piety_breakpoint(5), 0, 1},
            abflag::none },

        // Elyvilon
        { ABIL_ELYVILON_PURIFICATION, "Purification",
            0, 0, 0, -1, {fail_basis::invo, 20, 5, 20}, abflag::conf_ok },
        ...
        { ABIL_LUGONU_CORRUPT, "Corrupt",
            0, scaling_cost::fixed(5), 0, -1, {fail_basis::invo, 70, 4, 25},
            abflag::none },
        { ABIL_LUGONU_ABYSS_ENTER, "Enter the Abyss",
            0, 0, 0, -1, {fail_basis::invo, 80, 4, 25}, abflag::pain },
        ...
        { ABIL_NEMELEX_DEAL_FOUR, "Deal Four",
            0, 0, 0, -1, {fail_basis::invo, -1}, // failure special-cased
            abflag::none },
        ...
        { ABIL_JIYVA_OOZEMANCY, "Oozemancy",
            0, 0, 0, -1, {fail_basis::invo, 80, 0, 2}, abflag::none },
        { ABIL_JIYVA_SLIMIFY, "Slimify",
            0, 0, 0, -1, {fail_basis::invo, 90, 0, 2}, abflag::none },

        // Fedhas
        { ABIL_FEDHAS_WALL_OF_BRIARS, "Wall of Briars",
            0, 0, 0, -1, {fail_basis::invo, 30, 6, 20}, abflag::none },
        { ABIL_FEDHAS_GROW_BALLISTOMYCETE, "Grow Ballistomycete",
            0, 0, 0, 2, {fail_basis::invo, 60, 4, 25}, abflag::target },
        { ABIL_FEDHAS_OVERGROW, "Overgrow",
            0, 0, 0, LOS_MAX_RANGE, {fail_basis::invo, 70, 5, 20},
            abflag::none },
        { ABIL_FEDHAS_GROW_OKLOB, "Grow Oklob",
            0, 0, 0, 2, {fail_basis::invo, 80, 4, 25}, abflag::target },

        // Cheibriados
        { ABIL_CHEIBRIADOS_TIME_BEND, "Bend Time",
            0, 0, 0, -1, {fail_basis::invo, 40, 4, 20}, abflag::none },
        { ABIL_CHEIBRIADOS_DISTORTION, "Temporal Distortion",
            0, 0, 0, -1, {fail_basis::invo, 60, 5, 20}, abflag::instant },
        ...
        { ABIL_DITHMENOS_SHADOW_STEP, "Shadow Step",
            0, 80, 0, -1, {fail_basis::invo, 30, 6, 20}, // range special-cased
            abflag::none },
        { ABIL_DITHMENOS_SHADOW_FORM, "Shadow Form",
            0, 0, 0, -1, {fail_basis::invo, 80, 4, 25} },

        // Ru
        { ABIL_RU_DRAW_OUT_POWER, "Draw Out Power",
            0, 0, 0, -1, {fail_basis::invo},
            abflag::exhaustion | abflag::conf_ok },
        ...
        { ABIL_HEPLIAKLQANA_TRANSFERENCE, "Transference",
            0, 0, 0, LOS_MAX_RANGE, {fail_basis::invo, 40, 5, 20},
            abflag::none },
        ...
        { ABIL_IGNIS_FOXFIRE, "Foxfire Swarm",
            0, 0, 0, -1, {fail_basis::invo}, abflag::quiet_fail },
